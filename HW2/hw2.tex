...
\mathbf{q}_1 &= \frac{\mathbf{u}_1}{\|\mathbf{u}_1\|} = \frac{(-1, 1, -1)}{\sqrt{(-1)^2 + 1^2 + (-1)^2}} = \frac{(-1, 1, -1)}{\sqrt{3}} = \left( \frac{-1}{\sqrt{3}}, \frac{1}{\sqrt{3}}, \frac{-1}{\sqrt{3}} \right) &
\end{flalign*}
Note that $\mathbf{R}_2 = -1 \cdot \mathbf{R}_1$ and $\mathbf{R}_3 = \mathbf{R}_1$, making $\mathbf{B}$ rank deficient. We need $\mathbf{q}_2$ to be orthogonal to $\mathbf{q}_1$. We can choose any non zero nor parallel vector to $\mathbf{q}_1$:
\begin{flalign*}
\mathbf{v} &= (1, 0, 0) & \\
\mathbf{u}_2 &= \mathbf{v} - \text{proj}_{\mathbf{q}_1} (\mathbf{v}) = (1, 0, 0) - \left( (1, 0, 0) \cdot \mathbf{q}_1 \right) \mathbf{q}_1 & \\
&= (1, 0, 0) - \left( \frac{1 \cdot (-1)}{\sqrt{3}} + \frac{0 \cdot 1}{\sqrt{3}} + \frac{0 \cdot (-1)}{\sqrt{3}} \right) \frac{(-1, 1, -1)}{\sqrt{3}} = (1, 0, 0) - \frac{-1}{3} (-1, 1, -1) & \\
&= \left( 1 - \frac{1}{3}, 0 + \frac{1}{3}, 0 - \frac{1}{3} \right) = \left( \frac{2}{3}, \frac{1}{3}, \frac{-1}{3} \right) & \\
\mathbf{q}_2 &= \frac{\mathbf{u}_2}{\|\mathbf{u}_2\|} = \frac{\left( \frac{2}{3}, \frac{1}{3}, \frac{-1}{3} \right)}{\sqrt{\left( \frac{2}{3} \right)^2 + \left( \frac{1}{3} \right)^2 + \left( \frac{-1}{3} \right)^2}} = \frac{(2, 1, -1)}{\sqrt{2^2 + 1^2 + (-1)^2}} \\
...
\frac{-1}{\sqrt{3}} & \frac{-1}{\sqrt{6}} & \frac{-1}{\sqrt{2}}
\end{bmatrix}\]
\[\resizebox{0.9\hsize}{!}{$R = \begin{bmatrix}
(-1)(\frac{-1}{\sqrt{3}}) + 1(\frac{1}{\sqrt{3}}) + (-1)(\frac{-1}{\sqrt{3}}) & (-1)(\frac{-1}{\sqrt{3}}) + 1(\frac{1}{\sqrt{3}}) + (-1)(\frac{-1}{\sqrt{3}}) & (-1)(\frac{-1}{\sqrt{3}}) + 1(\frac{1}{\sqrt{3}}) + (-1)(\frac{-1}{\sqrt{3}}) \\
0 & (-1)(\frac{2}{\sqrt{6}}) + 1(\frac{1}{\sqrt{6}}) + (-1)(\frac{-1}{\sqrt{6}}) & (-1)(\frac{2}{\sqrt{6}}) + 1(\frac{1}{\sqrt{6}}) + (-1)(\frac{-1}{\sqrt{6}}) \\
0 & 0 & (-1)(0) + 1(\frac{-1}{\sqrt{2}}) + (-1)(\frac{-1}{\sqrt{2}})
\end{bmatrix}$}\]
